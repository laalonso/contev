        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <a class="btn btn-warning my-2" href="/root/university/services/laboratorio/detalles/personal/pdf/{{encrypt($service->id)}}">Descargar PDF</a><br>
                ...
                @php
                    $i=0;
                @endphp
                <a class="btn btn-warning my-2" href="/root/university/services/laboratorio/detalles/equipo/pdf/{{encrypt($service->id)}}">Descargar PDF</a><br>
                    <table class="table table-striped">
                        <thead>
                            <tr>                               
                                <th scope="col">#</th>
