        ...
        $(document).ready(function (){
            ...
            $.getJSON('https://semsys.sev.gob.mx/ApiGlobal/ApiGeneral/aievac/GetAllSubsTecno', function(data){
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    $("#tabla-uni").append("<tr><td>"+(i+1)+"</td><td>"+data[i].Nombre+"</td><td>"+data[i].NoTelefono+"</td><td>"+data[i].Correo+"</td><td><a class='btn-detalles btn btn-primary' id='"+data[i].Id_Subsistema+"' role='button'>Detalles</a></td><td><a class='btn btn-primary' href='/enterprise/projects/lista/"+data[i].Id_Subsistema+"' role='button'>Proyectos</a><td><a class='btn btn-primary' href='/enterprise/services/lista/"+data[i].Id_Subsistema+"' role='button'>Servicios</a><td></tr>");
                        
                }             /*<td><a class='btn-detalles btn btn-info' href='/enterprise/universidades/proyectos' role='button'>proyectos</a></td>
                    <td><a class='btn-detalles btn btn-info' href='/enterprise/universidades/servicios' role='button'>Servicios</a></td>
                    */
            });
