        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="float-left">{{ __('DIRECCIÓN') }} - <strong> {{ $all->university->name }} </strong></div>
                    <div class="float-right">
                        <form action=" {{ url('/root/addressuni/all/'.encrypt($all->university->id).'')}}" method="GET">
                            @csrf
                            @method('PUT')
                ...
                <div class="card-body">
                    <form action="{{ url('/root/addressuni/all/'.encrypt($all->id).'') }}" method="POST">
                    @method('PUT')
                    @csrf
